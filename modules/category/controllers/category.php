...
class product extends Public_Controller
{
    ...
    public function cat($cat_slug = null, $subcat_slug = null)
    {
    ...
    public function view($product_slug = null)
    {
        ...
        if($product->product_gallery){
            ...
            $product->product_gallery = $this->file_m->where('folder_id', $product->product_gallery)->get_all();
        }
        $this->data->product = $product;

        $this->template->title($product->product_name)
            ->append_js('colorbox/jquery.colorbox-min.js')
            ->append_css('colorbox/colorbox.css')
