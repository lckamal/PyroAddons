	...
	<div id="file-toolbar">
		<div id="file-buttons">
			<ul class="button-menu-source buttons">
                ...
                <li class="button animated fadeIn" data-applies-to="file" data-menu="select_file"><?php echo lang('imagepicker.select') ?></li>
			</ul>
		</div>
...
<section class="item" data-type="<?php echo $type; ?>">
	<section class="side">
	...
	<section class="center">
			...
			<ul class="context-menu-source">
                ...
                <li data-applies-to="file" data-menu="select_file"><?php echo lang('imagepicker.select') ?></li>
			</ul>
