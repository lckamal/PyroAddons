 ...
 <ol>
		...
		<li class="even">
			...
			<?php echo form_dropdown('start_time_hr', htmlspecialchars_decode($event->start_time_hr), 'maxlength="2" size="2" style="min-width: 75px;" class="text hour"'); ?> : 
			<?php echo form_dropdown('start_time_min', htmlspecialchars_decode($event->start_time_min), 'maxlength="2" size="2" style="min-width: 75px;" class="text min"'); ?>
		...
		<li style="text-align:right;">
			...
			<?php echo form_dropdown('end_time_hr', htmlspecialchars_decode($event->end_time_hr), 'maxlength="2" size="2" style="min-width: 75px;" class="text hour"'); ?> : 
			<?php echo form_dropdown('end_time_min', htmlspecialchars_decode($event->end_time_min), 'maxlength="2" size="2" style="min-width: 75px;" class="text min"'); ?>
