...
class Field_imagepicker
{
	 ...
	 * Required variables
	 */
	public $field_type_name = 'Image/File picker';
	...
	public function form_output($data, $id = false, $field)
	{
		...
		$field_name = $this->CI->fields->translate_label($field->field_name);
		$return .= '<button href="javascript:void(1)" data-type="'.$type.'" id="btn_'.$data['form_slug'].'" class="">Select '.$field_name.'</button>';
